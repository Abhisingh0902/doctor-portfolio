...
document.addEventListener('DOMContentLoaded', function() {
   ...
   const img = ["image/physiotherapy-doctor-assisting-elderly-patient-with-leg-exercise-clinic.jpg","image/pexels-pixabay-236380.jpg","image/bone-fracture-foot-leg-male-patient-being-examined-by-woman-doctor-hospital.jpg"];
...
//  autoslider function for dynamic banner 
document.addEventListener('DOMContentLoaded', function() {
let images = document.getElementById("img");
const img = ["image/physiotherapy-doctor-assisting-elderly-patient-with-leg-exercise-clinic.jpg","image/pexels-pixabay-236380.jpg","image/bone-fracture-foot-leg-male-patient-being-examined-by-woman-doctor-hospital.jpg"];
 count =  0;
...
var isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
  ...
  if (isMobile) {
    ...
    whatsappLink.href = "whatsapp://send?phone=6200577751";
  } else {
